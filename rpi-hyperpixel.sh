...
extras="bluez bluez-firmware firefox-esr i2c-tools python-configobj python-evdev python-pip python-requests python-rpi.gpio python-smbus xfonts-terminus triggerhappy wpasupplicant xfce4-terminal"
